...
- A weighted proportion of missing (NA) values was made for all predictors, covariates, and outcomes in this complete-case survey analysis. Although svyglm drops NA, documenting NAs demonstrates transparency and if any bias occurs due to the potential volume of missing data. 
